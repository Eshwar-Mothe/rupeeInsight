                ...
                >
                    <div >
                        <div className="card-container px-3 py-1 ">
                            ...
                            <div>
                                <img className='image' src="./feature1.png" alt="" style={{ width: '70%', objectFit: 'cover' }} />
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card-container px-3 py-1 ">
                            ...
                            <div>
                                <img className='image' src="./feature2.png" alt="" style={{ width: '70%', objectFit: 'cover' }} />
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card-container px-3 py-1 ">
                            ...
                            <div>
                                <img className='image' src="./feature3.png" alt="" style={{ width: '70%', objectFit: 'cover' }} />
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card-container px-3 py-1 ">
                            ...
                            <div>
                                <img className='image' src="./feature4.png" alt="" style={{ width: '70%', objectFit: 'cover' }} />
                            </div>
                        </div>
                    </div>
                </Carousel>
