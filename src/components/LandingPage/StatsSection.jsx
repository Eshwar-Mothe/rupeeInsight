...
const StatsSection = () => {
    ...
    const features = ['Active Users', 'Categories', 'Smart Expense Tracking', 'Accelerated Loan Payments', 'Smart Investment Strategies']
    useEffect(() => {
        const endValues = Array.from({ length: 6 }, () => Math.floor(Math.random() * (150 - 50 + 1)) + 50);
        const duration = 2000; 
